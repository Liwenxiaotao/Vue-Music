<template>
  <div class="music-list">
    ...
    <scroll :data="songs" @scroll="scroll" :probeType="proteType" :listen-scroll="listenScroll" class="list" ref="list">
      <div class="song-list-wrapper">
        <song-list @select="select" :songs="songs" :rank="rank"></song-list>
      </div>
