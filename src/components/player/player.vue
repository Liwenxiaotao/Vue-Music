      ...
      <div class="normal-player" v-show="fullScreen">
        ...
        <div class="bottom">
          ...
          <div class="progress-wrapper">
            ...
            <span class="time time-1">{{format(currentSong.duration)}}</span>
          </div>
          <div class="operators">
            ...
            <div class="icon i-left" :class="disabledCls">
              <i @click.passive="prev" class="icon-prev"></i>
            </div>
            <div class="icon i-center" :class="disabledCls">
              <i @click.passive="togglePlaying" :class="playIcon"></i>
            </div>
            <div class="icon i-right" :class="disabledCls">
              <i @click.passive="next" class="icon-next"></i>
            </div>
  ...
  methods: {
    ...
    enter(el, done) {
      ...
      let animation = {
        ...
        100: {
          translate3d: 'translate3d(0,0,0) scale(1)'
        }
      }
    ...
    middleTouchEnd(e) {
      ...
      this.$refs.middleL.style[transitionDuration] = `translate3d(${offsetWidth}px,0,0)`
    },
